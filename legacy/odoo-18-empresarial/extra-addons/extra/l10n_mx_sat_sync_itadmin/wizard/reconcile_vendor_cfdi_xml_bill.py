    ...
    def action_reconcile(self):
        ...
        for attachment in attachments:
            ...
            vals = {
                ...
                'forma_pago_id': self.env['catalogo.forma.pago'].sudo().search([('code','=',data.get('Comprobante',{}).get('@FormaPago',''))]).id,
                ...
                'uso_cfdi_id': self.env['catalogo.uso.cfdi'].sudo().search([('code','=',uso_data.get('@UsoCFDI'))]).id,
                }
            if self.typo_de_combante in ['P','SP']:
        ...
        if self.typo_de_combante in ['P','SP']:
            ...
            action_id = 'l10n_mx_sat_sync_itadmin.action_xml_entry_reconcile_view'
        else:
