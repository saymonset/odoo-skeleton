...
log "2. Eliminando base de datos existente..."
...
log "7. Actualizando referencias al filestore..."
...
# 8. Iniciar Odoo
log "9. Iniciando Odoo..."
docker start $WEB_CONTAINER

# 9. Verificar
log "10. Verificando estado..."
sleep 15
